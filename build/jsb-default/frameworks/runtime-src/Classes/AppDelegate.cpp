...
bool AppDelegate::applicationDidFinishLaunching()
{
    ...
    if(!glview) {
        ...
        glview = cocos2d::GLViewImpl::create("starcatcher");
#else
        glview = cocos2d::GLViewImpl::createWithRect("starcatcher", Rect(0,0,900,640));
#endif
    ...
    sc->addRegisterCallback(register_all_happycandlesbridgebindings);
#endif
    sc->start();
