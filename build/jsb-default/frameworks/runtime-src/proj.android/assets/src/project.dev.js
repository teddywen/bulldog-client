...
},{"buffer":2}],"Game":[function(require,module,exports){
"use strict";
...
cc.Class({
    ...
    getNewStarPosition: function getNewStarPosition() {
        var randX = 0;
        var randY = this.groundY + cc.random0To1() * this.player.getComponent('Player').jumpHeight + 36;
    ...
    gainScore: function gainScore() {
        this.scoreCount += 1;
        this.score.string = 'Score: ' + this.scoreCount.toString();
