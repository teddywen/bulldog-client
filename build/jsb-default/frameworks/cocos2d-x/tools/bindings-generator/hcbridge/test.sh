...
LD_LIBRARY_PATH=${CXX_GENERATOR_ROOT}/libclang $PYTHON_BIN ${CXX_GENERATOR_ROOT}/generator.py ${CXX_GENERATOR_ROOT}/hcbridge/test.ini -t spidermonkey -s testandroid -o ./hc_bridge_bindings
